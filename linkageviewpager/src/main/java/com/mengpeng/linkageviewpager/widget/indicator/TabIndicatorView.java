package com.mengpeng.linkageviewpager.widget.indicator;
...
public class TabIndicatorView extends LinearLayout implements Indicator {
    ...
    private class InRun implements Runnable {
        ...
        public void startScroll(int startX, int endX, int dration) {
            ...
            ViewCompat.postInvalidateOnAnimation(TabIndicatorView.this);
            post(this);
        }
